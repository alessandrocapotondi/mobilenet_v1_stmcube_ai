...
#undef AI_MOBILENET_N_BATCHES
#define AI_MOBILENET_N_BATCHES         (1)
...
AI_TENSOR_OBJ_DECLARE(
  input_1_output,
  AI_SHAPE_INIT(160, 160, 3, 1),
  AI_STRIDE_INIT(1920, 12, 4, 4),
  &input_1_output_array,
  AI_STATIC)
AI_TENSOR_OBJ_DECLARE(
  conv1_output,
  AI_SHAPE_INIT(80, 80, 8, 1),
  AI_STRIDE_INIT(2560, 32, 4, 4),
  &conv1_output_array,
  AI_STATIC)
AI_TENSOR_OBJ_DECLARE(
  conv_dw_1_output,
...
AI_TENSOR_OBJ_DECLARE(
  conv_pw_1_output,
  AI_SHAPE_INIT(80, 80, 16, 1),
  AI_STRIDE_INIT(5120, 64, 4, 4),
  &conv_pw_1_output_array,
  AI_STATIC)
AI_TENSOR_OBJ_DECLARE(
  conv_dw_2_output,
  AI_SHAPE_INIT(40, 40, 16, 1),
  AI_STRIDE_INIT(2560, 64, 4, 4),
  &conv_dw_2_output_array,
  AI_STATIC)
AI_TENSOR_OBJ_DECLARE(
  conv_pw_2_output,
  AI_SHAPE_INIT(40, 40, 32, 1),
  AI_STRIDE_INIT(5120, 128, 4, 4),
...
AI_TENSOR_OBJ_DECLARE(
  conv_dw_4_output,
  AI_SHAPE_INIT(20, 20, 32, 1),
  AI_STRIDE_INIT(2560, 128, 4, 4),
  &conv_dw_4_output_array,
  AI_STATIC)
AI_TENSOR_OBJ_DECLARE(
  conv_pw_4_output,
  AI_SHAPE_INIT(20, 20, 64, 1),
  AI_STRIDE_INIT(5120, 256, 4, 4),
...
AI_TENSOR_OBJ_DECLARE(
  conv_pw_6_output,
  AI_SHAPE_INIT(10, 10, 128, 1),
  AI_STRIDE_INIT(5120, 512, 4, 4),
...
AI_TENSOR_OBJ_DECLARE(
  conv_dw_12_output,
  AI_SHAPE_INIT(5, 5, 128, 1),
  AI_STRIDE_INIT(2560, 512, 4, 4),
  &conv_dw_12_output_array,
  AI_STATIC)
AI_TENSOR_OBJ_DECLARE(
  conv_pw_12_output,
  AI_SHAPE_INIT(5, 5, 256, 1),
  AI_STRIDE_INIT(5120, 1024, 4, 4),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 614404, 1,
                     NULL),
  &input_1_output, &conv_preds_output,
  &conv1_layer, 0)


AI_DECLARE_STATIC
ai_bool mobilenet_configure_activations(
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    input_1_output_array.data = NULL;
  input_1_output_array.data_start = NULL;
  conv1_output_array.data = activations + 0;
  conv1_output_array.data_start = activations + 0;
  conv_dw_1_output_array.data = activations + 409600;
  conv_dw_1_output_array.data_start = activations + 409600;
  conv_pw_1_output_array.data = activations + 0;
  conv_pw_1_output_array.data_start = activations + 0;
  conv_dw_2_output_array.data = activations + 409600;
  conv_dw_2_output_array.data_start = activations + 409600;
  conv_pw_2_output_array.data = activations + 0;
  conv_pw_2_output_array.data_start = activations + 0;
  conv_dw_3_output_array.data = activations + 204800;
  conv_dw_3_output_array.data_start = activations + 204800;
  conv_pw_3_output_array.data = activations + 0;
  conv_pw_3_output_array.data_start = activations + 0;
  conv_dw_4_output_array.data = activations + 204800;
  conv_dw_4_output_array.data_start = activations + 204800;
  conv_pw_4_output_array.data = activations + 0;
  conv_pw_4_output_array.data_start = activations + 0;
  conv_dw_5_output_array.data = activations + 102400;
  conv_dw_5_output_array.data_start = activations + 102400;
  conv_pw_5_output_array.data = activations + 0;
  conv_pw_5_output_array.data_start = activations + 0;
  conv_dw_6_output_array.data = activations + 102400;
  conv_dw_6_output_array.data_start = activations + 102400;
  conv_pw_6_output_array.data = activations + 0;
  conv_pw_6_output_array.data_start = activations + 0;
  conv_dw_7_output_array.data = activations + 51200;
  conv_dw_7_output_array.data_start = activations + 51200;
  conv_pw_7_output_array.data = activations + 0;
  conv_pw_7_output_array.data_start = activations + 0;
  conv_dw_8_output_array.data = activations + 51200;
  conv_dw_8_output_array.data_start = activations + 51200;
  conv_pw_8_output_array.data = activations + 0;
  conv_pw_8_output_array.data_start = activations + 0;
  conv_dw_9_output_array.data = activations + 51200;
  conv_dw_9_output_array.data_start = activations + 51200;
  conv_pw_9_output_array.data = activations + 0;
  conv_pw_9_output_array.data_start = activations + 0;
  conv_dw_10_output_array.data = activations + 51200;
  conv_dw_10_output_array.data_start = activations + 51200;
  conv_pw_10_output_array.data = activations + 0;
  conv_pw_10_output_array.data_start = activations + 0;
  conv_dw_11_output_array.data = activations + 51200;
  conv_dw_11_output_array.data_start = activations + 51200;
  conv_pw_11_output_array.data = activations + 0;
  conv_pw_11_output_array.data_start = activations + 0;
  conv_dw_12_output_array.data = activations + 51200;
  conv_dw_12_output_array.data_start = activations + 51200;
  conv_pw_12_output_array.data = activations + 0;
  conv_pw_12_output_array.data_start = activations + 0;
  conv_dw_13_output_array.data = activations + 25600;
  conv_dw_13_output_array.data_start = activations + 25600;
...
AI_DECLARE_STATIC
ai_bool mobilenet_configure_weights(
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_MOBILENET_MODEL_NAME,
      .model_signature   = AI_MOBILENET_MODEL_SIGNATURE,
      ...
      .inputs            = AI_BUFFER_OBJ_INIT(
                              ...
                              3,
                              1, NULL),
      .n_outputs         = AI_MOBILENET_OUT_NUM,
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= mobilenet_configure_weights(net_ctx, &params->params);
  ok &= mobilenet_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_mobilenet_forward(ai_handle network, const ai_buffer* input)
{
