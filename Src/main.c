...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, Mobilenet_Pin|RedLED_Pin|BlueLED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : Mobilenet_Pin */
  GPIO_InitStruct.Pin = Mobilenet_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(Mobilenet_GPIO_Port, &GPIO_InitStruct);
